...
import mythec from "../public/assets/images/mythec.svg";
...
const workData = [
  {
    id: 1,
    company: "Mythec",
    role: "Apprenti en développement M365",
    startTime: "Fév 2024",
    endTime: "Présent",
    image: mythec,
  },
  ...
  },
  {
    ...
    role: "Agent d'accueil et d'information",
    startTime: "Jan 2023",
    endTime: "July 2023",
    image: Samsic,
  },
  ...
  },
  {
    ...
    role: "Intituteur vacataire d'IT",
  ...
  return (
    <div className="rounded-2xl  ring-[0.2px] ring-textLight  p-6 dark:border-zinc-100">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3 text-textLight">Expérience Profesionnel</span>
      </h2>
